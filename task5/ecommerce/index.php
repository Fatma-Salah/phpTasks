...
use app\database\models\Product;
 ...
 $productObject =new Product;
		 ...
		 $brandResult = $brandObject->allBrands('*','name_en');
     ...
     ?>
							...
							<div class="product-wrapper mb-30">
									<div class="product-img">
										<a href="shop.php?brand= <?= $brand['id']?>">
											<img  height="200px" alt="" src="assets/img/brands/<?= $brand['image']?>">
										</a>
										<span>-30%</span>
										<!-- <div class="product-action">
											<a class="action-wishlist" href="#" title="Wishlist">
        ...
        <div  class="container m-5">  <h1 style="color:#464 ; text-align:center ; margin:11px ;padding:22px"> Most recent Product</h1>
        <div class="row">
                                <?php  
        ...
        <div  class="container m-5 ">  <h1 style="color:#464 ; text-align:center ; margin:11px ;padding:22px"> Most reated Product</h1>
        <div class="row">
                                <?php  
                                    $findReatedProductResult = $productObject->getReatedProduct();
                                     if( $findReatedProductResult ->num_rows >=1)
                                    {
                                         $ReatedProductResult = $findReatedProductResult->fetch_all(MYSQLI_ASSOC);
                                        // print_r($LatestProductResult);die;
                                    }
                                    
                                    foreach($ReatedProductResult AS $ReatedProduct)
                                    {
                                    ?>
                                  <div class="m-3 col">
                                  <div class="product-wrapper">
                                            <div class="product-img row">
                                                <a href="product-details.php?product=<?=  $ReatedProduct['id'] ?>">
                                                    <img height="250px" alt="" src="assets/img/product/<?=  $ReatedProduct['image']; ?>">
                                        ...
                                        <div class="product-content text-left">
												<div class="product-hover-style">
													<div class="product-title">
														<h4>
															<a href="product-details.php?product=<?= $ReatedProduct['id'] ?>"><?= $ReatedProduct['name_en']; ?></a>
														</h4>
													</div>
													<div class="cart-hover">
														<h4><a href="product-details.php?product=<?= $ReatedProduct['id'] ?>">+ Add to cart</a></h4>
													</div>
												</div>
												<div class="product-price-wrapper">
                                                <span  style="color: #464;"> Price   : </span><span><?= $ReatedProduct['price']; ?></span>
												
												</div>
                                                <div class="product-price-wrapper">
													<span  style="color: #464;"> count of reviews is :  </span> <span> <?= $ReatedProduct['reviews_count']; ?></span>
												</div>
                                                <div class="product-price-wrapper">
													<span  style="color: #464;"> Average reviews is :  </span> <span> <?= $ReatedProduct['reviews_avg']; ?></span>
												</div>
											</div>
