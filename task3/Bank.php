...
<body>
    ...
    <form action="" method="post" class="form-group w-50 m-auto ">
        ...
        <div>
            ...
            <input type="number" name="LoanAmount" id="LoanAmount" value="<?php if (isset($_POST['LoanAmount'])) {
                                                                                echo $_POST['LoanAmount'];
                                                                            } ?>" class="form-control mb-4" placeholder="" aria-describedby="helpId">
            <?php
            ...
            <input type="number" name="loanYears" id="loanYears" value="<?php if (isset($_POST['loanYears'])) {
